...
shiny.appfile <- "app.R"  # Adjust the file name accordingly
library(shiny)
library(ggplot2)
library(dplyr)
library(tidyr)
...
options(gargle_oauth_cache = ".secrets/client_secret.json") ##Will need to create your own client_secret.json file on googlesheets api service

#Go to Google APIs
#create a project and create an API
#Go to Credentials
#share dataset with whatever email is created for API
#Under 0Auth 2.0 Client ID's download a key after creating one
#Hide that json file as client_secret.json within a .secrets folder
...
bsize <- 16 #adjusts font sizes
sz <- 4.4 #adjusts font sizes
